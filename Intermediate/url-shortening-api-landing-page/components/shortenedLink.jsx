...
const ShortenedLink = ({ shortenedLinks }) => {
  ...
  return shortenedLinks.map((link) => (
    <div
      ...
      className="mt-14 md:mt-2 pr-2 md:pr-5 pl-3 py-2 w-full bg-white rounded-md md:rounded-sm"
    >
      <div className="md:inline-block md:w-11/12 px-2">
        <div className=" md:flex md:justify-between md:items-center ">
          <p
            // style={{ fontSize: "15%" }}
            className="flex-1 break-words text-md py-2 md:py-0 text-center md:text-left md:text-sm text-very-dark-violet-color"
          >
            {link.originalUrl}
          </p>
          <hr
      ...
      {/* custom copy button */}
      <div className="md:inline-block md:w-11">
        <div
